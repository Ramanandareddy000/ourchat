...
const conversationsToCreate = [
  ...
  // Group conversations
  { name: 'Family Group', is_group: true, participants: ['raja', 'suresh', 'priya'] },
  { name: 'Office Team', is_group: true, participants: ['raja', 'ananya', 'rahul', 'neha'] },
];
...
const messagesToCreate = [
  ...
  // Messages for Raja and Ananya
  {
    ...
    messages: [
      ...
      { text: "It was great! Went hiking with family. How about you?", sender: 'raja' },
